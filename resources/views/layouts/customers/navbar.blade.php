      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center lg:space-x-2">
          ...
          <div id="myCartDropdown1" class="hidden z-40 mx-auto max-w-sm space-y-4 overflow-hidden rounded-lg bg-white p-4 antialiased shadow-lg dark:bg-gray-800">
            ...
            <a href="{{ route('customers-cart') }}" title="" class="mb-2 me-2 inline-flex w-full items-center justify-center rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" role="button"> Sepete Git </a>
          </div>
