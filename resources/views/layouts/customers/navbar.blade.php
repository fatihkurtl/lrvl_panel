      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center lg:space-x-2">
          ...
          <button id="myCartDropdownButton1" data-dropdown-toggle="myCartDropdown1" type="button" class="{{ request()->routeIs('customers-cart') ? 'text-blue-700':'' }} inline-flex items-center rounded-lg justify-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm font-medium leading-none text-gray-900 dark:text-white">
            ...
            <span class="hidden sm:flex">Sepet</span>
          ...
          <div id="myCartDropdown1" class="hidden z-40 mx-auto max-w-sm space-y-4 overflow-hidden rounded-lg bg-white p-4 antialiased shadow-lg dark:bg-gray-800">
            ...
            <a href="{{ url('/sepet') }}" title="" class="mb-2 me-2 inline-flex w-full items-center justify-center rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" role="button"> Sepete Git </a>
          </div>
          ...
          <div id="userDropdown1" class="hidden z-40 w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white antialiased shadow dark:divide-gray-600 dark:bg-gray-700">
            <ul class="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
              ...
              <li><a href="{{ route('orders-index') }}" title="" class="{{ request()->routeIs('orders-index') ? 'text-blue-700':'' }} inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600"> Siparişlerim </a></li>
