<section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-16">
    <div
        ...
        <div class="lg:col-span-5 lg:mt-0">
            <a href="#">
                <img class="mb-4 h-56 w-56 dark:hidden sm:h-96 sm:w-96 md:h-full md:w-full"
                    src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-components.svg" alt="peripherals" />
        ...
        <div class="me-auto place-self-center lg:col-span-7">
            ...
            <p class="mb-6 text-gray-500 dark:text-gray-400">Reserve your new Apple iMac 27” today and enjoy exclusive
