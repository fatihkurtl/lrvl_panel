                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Products</a>
                            </div>
                        </li>
                    ...
                    <div class="pt-6">
                        ...
                        <ul class="mt-2 flex items-center gap-4">
                            <li class="flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Hızlı Teslimat</p>
                            </li>
                            ...
                            <li class="flex items-center gap-2">
                                @if ($product->price < 2000)
                                    ...
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">En İyi Fiyat</p>
                                @endif
                            </li>
                        </ul>
        ...
        <div class="relative h-full w-full max-w-xl md:h-auto">
            ...
            <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                ...
                <div class="flex items-start justify-between rounded-t p-4 md:p-5">
                    <h3 class="text-lg font-normal text-gray-500 dark:text-gray-400">Filtreler</h3>
                    <button type="button"
                        ...
                        <div class="grid grid-cols-2 gap-4 md:grid-cols-3" id="brand" role="tabpanel"
                            ...
                            <div class="space-y-2">
                                ...
                                @foreach ($categories as $cat)
                                    <div class="flex items-center">
                                        <input id="{{ $cat->category }}" type="checkbox" name="kategori[]"
                                            value="{{ $cat->category }}"
